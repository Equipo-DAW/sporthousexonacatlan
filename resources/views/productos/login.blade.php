              ...
              <form action = "{{route('comprar')}}" method = "POST">
                ...
                <button class="btn btn-lg btn-primary btn-block btn-login text-uppercase font-weight-bold mb-2" type="submit">Iniciar Sesión</button>
                  <div class="text-center">
                    <a href="http://localhost:8080/sporthouse-local/productos" class="small">Cancelar</a>
                  </div>
                  <br>
                  <div class="text-center">
                    <a  href="{{URL::action('ProductosController@nuevoCliente')}}" class="small"> + Nuevo Cliente</a>
                  </div>
                  <br>
              </form>
            </div>
