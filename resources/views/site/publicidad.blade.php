				...
				<div class="row">
					@foreach($banners as $b)
                      ...
                      <div class="div-imagen">
                        <div>
                            <a href="{{asset('storage/app/public/'.$b->banner)}}" title="" ><center><b>{{$b->descripcion}}</b></center></a>
                        </div>
                            <img class="desvanecer" src= "{{asset('storage/app/public/'.$b->banner)}}" style="width:450px; height:300px;"></a>
                      </div>
										</div>
								</div>
						</div>
